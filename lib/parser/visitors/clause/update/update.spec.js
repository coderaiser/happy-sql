...
test('happy-sql: parser: clause: update: update-returning', (t) => {
    t.transform('update-returning');
    t.end();
});

test('happy-sql: parser: clause: update-or-replace', (t) => {
    t.transform('update-or-replace');
    t.end();
});

test('happy-sql: parser: clause: update-or-ignore', (t) => {
    t.transform('update-or-ignore');
    t.end();
});

test('happy-sql: parser: clause: update-or-abort', (t) => {
    t.transform('update-or-abort');
    t.end();
});

test('happy-sql: parser: clause: update-or-fail', (t) => {
    t.transform('update-or-fail');
    t.end();
});
