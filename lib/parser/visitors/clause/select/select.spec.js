...
test('happy-sql: parser: clause: select: sum', (t) => {
    t.transform('select-sum');
    t.end();
});

test('happy-sql: parser: clause: select: avg', (t) => {
    t.transform('select-avg');
    t.end();
});

test('happy-sql: parser: clause: select: min-max', (t) => {
    t.transform('select-min-max');
    t.end();
});

test('happy-sql: parser: clause: select: count-col', (t) => {
    t.transform('select-count-col');
    t.end();
});

test('happy-sql: parser: clause: select: distinct', (t) => {
