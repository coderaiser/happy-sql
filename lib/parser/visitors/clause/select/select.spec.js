...
test('happy-sql: parser: clause: select: select-over-frame-unbounded', (t) => {
    t.transform('select-over-frame-unbounded');
    t.end();
});

test('happy-sql: parser: clause: select: select-over-frame-unbounded-following', (t) => {
    t.transform('select-over-frame-unbounded-following');
    t.end();
});
