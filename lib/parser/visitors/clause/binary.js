...
const convertJsonArrow = (node) => callExpression(identifier('jsonArrow'), [
    convertOperand(node.left),
    convertOperand(node.right),
]);

const convertJsonDoubleArrow = (node) => callExpression(identifier('jsonDoubleArrow'), [
    convertOperand(node.left),
    convertOperand(node.right),
]);
