...
test('happy-sql: parser: clause: from: join-using', (t) => {
...
test('happy-sql: parser: clause: from: order-by-ordinal', (t) => {
    t.transform('order-by-ordinal');
    t.end();
});

test('happy-sql: parser: clause: from: order-by-nulls-first', (t) => {
    t.transform('order-by-nulls-first');
    t.end();
});

test('happy-sql: parser: clause: from: order-by-desc-nulls-last', (t) => {
    t.transform('order-by-desc-nulls-last');
    t.end();
});
...
test('happy-sql: parser: clause: from: join-using-multi', (t) => {
    t.transform('join-using-multi');
    t.end();
});
