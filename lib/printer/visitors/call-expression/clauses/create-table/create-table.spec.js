...
test('happy-sql: printer: clause: createTable: createTableTemp', (t) => {
    t.transform('createTableTemp');
    t.end();
});

test('happy-sql: printer: clause: createTable: createTableTempIfNotExists', (t) => {
    t.transform('createTableTempIfNotExists');
    t.end();
});

test('happy-sql: printer: clause: createTable: createTableWithoutRowid', (t) => {
    t.transform('createTableWithoutRowid');
    t.end();
});
